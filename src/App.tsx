  ...
  const heroMetrics = [
    {
      ...
      value: '20+ years driving regulated modernization and AI adoption'
    },
    {
    ...
    },
    {
      ...
      value: 'Cloud-native platforms, DevSecOps and integration architectures'
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      <header className="sticky top-0 z-50 border-b border-slate-800/60 bg-slate-950/95 backdrop-blur-xl">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 py-4">
            <div>
              <p className="text-xs uppercase tracking-[0.32em] text-cyan-300/70">Amarpreet Bhatia</p>
      ...
      <section className="relative overflow-hidden px-4 py-16 sm:py-20 lg:py-24">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.16),_transparent_30%),radial-gradient(circle_at_bottom_right,_rgba(168,85,247,0.14),_transparent_24%)] pointer-events-none" />
        <div className="relative container mx-auto">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold tracking-tight text-white">Enterprise AI transformation leadership for cloud, platform engineering and secure AI operating models.</h1>
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-slate-300">I partner with executive teams to architect AI-first strategies, modernize enterprise platforms, and deliver measurable value with disciplined, governance-ready cloud and DevSecOps practices.</p>
          </div>
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:justify-center sm:gap-5">
            ...
            <Button asChild className="w-full sm:w-auto bg-slate-900/90 text-white border border-slate-700 hover:bg-slate-800 px-6 py-3 font-semibold shadow-sm">
              <a href="https://www.linkedin.com/in/amarpreetbhatia/" target="_blank" rel="noopener noreferrer">Connect on LinkedIn</a>
            </Button>
          </div>
